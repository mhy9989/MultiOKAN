# Based on this: https://github.com/sidhu2690/RBF-KAN/blob/main/Fast_RBF_KAN.py
import torch
...
class RBFKANLayer(nn.Module):
   def __init__(self, input_dim, output_dim, grid_min=-2., grid_max=2., num_grids=8, use_base_update=True, 
                base_activation=nn.SiLU(), spline_weight_init_scale=0.1,**kwargs):
       super().__init__()
...
class RBFKAN(nn.Module):
   def __init__(self, layers_hidden, num_grids=8, grid_min=-2., grid_max=2., use_base_update=True, base_activation=nn.SiLU(), 
                spline_weight_init_scale=0.1,**kwargs):
       super().__init__()
