...
def predata(in_path = "base-ae-kan",out_path = "base-don-kan"): # wirte DON config to settings
    ...
    out_args.data_config.data_num=in_args.data_config.data_num
    out_args.data_config.data_width=in_args.data_config.data_width
    out_args.data_config.data_height=in_args.data_config.data_height
    out_args.data_config.data_std=std
    out_args.data_config.data_max=max
    out_args.data_config.data_min=min
    out_args.data_config.data_type=in_args.data_config.data_type
    out_args.data_config.data_select=in_args.data_config.data_select
    out_args.data_config.data_scaler[0]=in_args.data_config.data_scaler[0]
    ...
    out_args.data_config.valid_ratio_in_train=in_args.data_config.valid_ratio_in_train
    out_args.data_config.test_ratio=in_args.data_config.test_ratio
