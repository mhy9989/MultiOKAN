...
Part of the dataset used in this project is available on Zenodo:

Men, H., & Mao, Y. (2026). *Encoding multiphase dynamics to predict spatiotemporal evolution via latent-space operators* [Data set]. In *Communications AI & Computing* (Version v1). Zenodo. https://doi.org/10.5281/zenodo.20327008
